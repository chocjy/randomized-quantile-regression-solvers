...
for t = 1:4
  for l = 1:data.ntau
    ...
    for j = 1:data.ns
      ...
      hh(j) = plot(data.n_vec, c.errors{t}.q1(:,j,l), [colors{j}, '-'], 'LineWidth', 2);
      plot(data.n_vec, c.errors{t}.q3(:,j,l), [colors{j}, '--'], 'LineWidth', 2);
    end
    ...
    set(gca, 'Xscale', 'log', 'Yscale', 'log', 'Ytick', yti, 'FontSize', 30);
